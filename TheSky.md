## 天空
天空是一款基于HTML + CSS + JS + Vue + **C++ + WASM(可选，优化画面绘制的性能)**的一款专注于画面演出的2D游戏  
...
<head>
    ...
    <title>Ascension: The Flow of Realms</title>
    <style>
        body {
            margin: 0;
            overflow: hidden;
...
<body>
    ...
    <div id="fx-layer"></div>
    <div id="ui">
        <h1 id="scene-name">ETHEREAL FLOW</h1>
        <div class="guide">HOLD [SPACE] TO ACCELERATE</div>
    </div>
